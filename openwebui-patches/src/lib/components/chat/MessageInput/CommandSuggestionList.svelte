<script lang="ts">
	import Hermes from './Commands/Hermes.svelte';
...
<div
	class="{(filteredItems ?? []).length > 0
		? ''
		: 'hidden'} rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800 flex flex-col bg-white dark:bg-gray-850 w-96 max-w-[90vw] p-1"
